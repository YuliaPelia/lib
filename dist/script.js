...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    const slidesFild = this[i].querySelector('.carousel-slides');
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].querySelector('[data-slide="prev"]')).click(e => {
      e.preventDefault();
      //коли слайдер дійде до кінця слайдера
      if (offset == 0) {
        offset = +width.replace(/\D/g, '') * (slides.length - 1);
        // якщо ми не дійшли до кінця слайдера
      } else {
        offset -= +width.replace(/\D/g, '');
      }
      slidesFild.style.transform = `translateX(-${offset}px)`;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(e => {
      ...
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(target).style.display = 'block';
...
// dur - довжина анімації
// fin - callback який можливо виконається по завершенні анімації
